...
Authentication: `Authorization: Bearer $ECLIPSE_CLAW_API_KEY`
...
curl -X POST https://api.webclaw.io/v1/scrape \
  -H "Authorization: Bearer $ECLIPSE_CLAW_API_KEY" \
...
Use `web_fetch` for simple, fast lookups. Use eclipse-claw when you need reliability, quality, or advanced features.
