...
Extraction quality and performance benchmarks comparing eclipse-claw against popular alternatives.

## Quick Run

```bash
# Run all benchmarks
cargo run --release -p eclipse-claw-bench

# Run specific benchmark
cargo run --release -p eclipse-claw-bench -- --filter quality
cargo run --release -p eclipse-claw-bench -- --filter speed
```
...
|-----------|----------|---------------|-------|----------|-----------|
| **eclipse-claw** | **94.2%** | **96.1%** | **98.3%** | **91.7%** | **95.1%** |
...
### Why eclipse-claw scores higher
...
| Page Size | eclipse-claw | readability | trafilatura |
|-----------|---------|-------------|-------------|
...
| eclipse-claw markdown | 1,840 | **-62%** |
| eclipse-claw text | 1,620 | **-66%** |
...
| Concurrency | eclipse-claw | Crawl4AI | Scrapy |
|-------------|---------|----------|--------|
...
| Protection | eclipse-claw | Firecrawl | Bright Data |
|------------|---------|-----------|-------------|
...
cargo run --release -p eclipse-claw-bench -- --filter tokens

# Full benchmark suite with HTML report
cargo run --release -p eclipse-claw-bench -- --report html
```
